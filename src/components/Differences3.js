        ...
        <div className="flex justify-center w-[50%] max-[1024px]:w-[70%]  ">
          <div className="flex gap-3 flex-col ">
            ...
            <p className="font-light text-[#262625] text-base mt-2 mb-2 w-[95%] max-[1024px]:w-full">
              Durante todo o processo de design da página, entramos em contato
              com você constantemente para verificar se tudo está de acordo com
              o que foi pedido. Não iniciamos o desenvolvimento sem a validação
              das telas sem a sua validação.
            </p>
