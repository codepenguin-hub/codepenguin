...
export default () => {
	...
	return (
		<div
			className="p-[20px] overflow-hidden flex justify-center items-center min-[1280px]:h-[450px] min-[1024px]:h-[350px] min-[768px]:h-[300px] min-[640px]:h-[250px] min-[500px]:h-[230px] h-[30vh] w-[100vw] relative"
